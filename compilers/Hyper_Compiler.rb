module Hyper_Compiler
  ...
  def compile_domain(domain_name, problem_name, operators, methods, predicates, state, tasks, goal_pos, goal_not, hypertension_filename = '../../Hypertension')
    ...
    hypertension_filename ? "# Generated by Hype\nrequire File.expand_path('../#{hypertension_filename}', __FILE__)\n\n#{domain_str}" : domain_str
  end
