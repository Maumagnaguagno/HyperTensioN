module Hyper_Compiler
  ...
  def compile_domain(domain_name, problem_name, operators, methods, predicates, state, tasks, goal_pos, goal_not, require_files = nil)
